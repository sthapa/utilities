...
yum install -y --enablerepo=epel yum-plugin-priorities
yum install -y --enablerepo=epel MySQL-python readline-devel openssl-devel munge-devel munge-libs pam-devel
yum install -y --enablerepo=epel rpm-build
yum install -y --enablerepo=epel mysql-server mysql-devel
